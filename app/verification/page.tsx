                ...
                <Card className="bg-blue-50 border border-blue-200 mb-6 text-left">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-slate-800">{verificationResult.student.name}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-slate-800">{verificationResult.student.department}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-slate-800 text-xs">{verificationResult.student.email}</span>
                    </div>
                ...
                {verificationResult.success ? (
                  <>
                    ...
                    <Button 
                      ...
                      variant="outline"
                      className="w-full border-green-600 text-green-600 hover:bg-green-600/10 font-medium"
                    >
                  ...
                  <Button 
                    ...
                    className="w-full flex items-center justify-center space-x-2 border-blue-600 text-blue-600 hover:bg-blue-600/10 font-medium"
                  >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold text-slate-800">Face Verification System</h1>
            <p className="text-blue-600 text-sm">Identity Verification Portal</p>
          </div>
          <div className="w-20"></div>
        </div>

        {error && (
          <Card className="mb-6 border-red-300 bg-red-50 backdrop-blur-xl">
          ...
          <Card className="bg-white/90 backdrop-blur-2xl border border-blue-300 relative overflow-hidden shadow-xl">
            <div className="relative z-10 p-6">
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-slate-800 mb-2">Face Capture</h2>
                <p className="text-slate-600 text-sm">Align face with scan area</p>
              </div>
                ...
                {isVerifying && (
                  <div className="absolute inset-0 bg-white/90 backdrop-blur-sm flex items-center justify-center">
                    <div className="text-center text-slate-800">
                      ...
                      <p className="text-lg font-medium">Analyzing Face Pattern</p>
                ...
                {isCapturing ? (
                  <>
                    ...
                    <Button 
                      ...
                      onClick={stopCamera}
                      disabled={isVerifying}
                      className="w-full border-blue-600 text-blue-600 hover:bg-blue-600/10 font-medium"
                    >
                      Turn Off Camera
                    </Button>
                  </>
              ...
              {capturedImage && !isVerifying && (
                <div className="mt-4 p-3 bg-blue-500/10 rounded-lg border border-blue-300">
          ...
          <div className="space-y-6">
            <Card className="bg-white/90 backdrop-blur-2xl border border-blue-300">
              ...
              <div className="space-y-3 text-sm text-slate-600">
                ...
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mt-1.5 mr-3 animate-pulse"></div>
                  <span>Hold still during capture</span>
                </div>
              </div>
            </Card>
            ...
            <Card className="bg-green-50 border border-green-200">
              <h3 className="font-bold text-slate-800 mb-2">Support</h3>
              <p className="text-slate-600 text-sm mb-3">
                Need assistance with face scan?
              </p>
              <div className="space-y-2 text-sm text-slate-600">
                <p>📞 Support Line: +234-XXX-XXXX</p>
                <p>✉️ Email: support@uniport.edu.ng</p>
                <p>🏢 Location: IT Help Desk, Main Building</p>
              </div>
            </Card>
          </div>
        </div>
