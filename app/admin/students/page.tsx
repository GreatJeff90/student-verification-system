...
import { Search, Plus, Users, Edit, Trash2, Download, Filter, MoreVertical } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage registered students and their facial data</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Avg. Verifications</p>
              <p className="text-2xl font-bold text-gray-900">
