...
import { Shield, Users, Clock, BarChart3, Camera, UserPlus, Cpu, Brain, Zap, Sparkles } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-slate-100 relative overflow-hidden">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">FaceID Verification System</p>
              </div>
            </div>
            <nav className="flex items-center space-x-6">
              <Link href="/admin" className="text-blue-600 hover:text-blue-800 font-medium text-sm transition-all duration-300 hover:underline">
                Admin Portal
              </Link>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-12">
            {/* Animated Badge */}
            <div className="inline-flex items-center px-6 py-3 rounded-full bg-blue-500/10 border border-blue-500/20 mb-8 backdrop-blur-sm relative overflow-hidden group">
              <div className="absolute inset-0 bg-blue-500/5 group-hover:bg-blue-500/10 transition-all duration-500"></div>
              <Sparkles className="w-5 h-5 text-blue-600 mr-3 relative z-10" />
              <span className="text-sm font-medium text-blue-700 relative z-10">
            ...
            {/* Main Heading */}
            <h1 className="text-6xl lg:text-7xl font-black text-slate-900 mb-8 leading-tight">
              <span className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 bg-clip-text text-transparent">
                FaceID
              </span>
              <span className="block text-4xl lg:text-5xl text-slate-700 mt-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto mb-16">
            {[
              ...
              <div key={index} className="text-center group">
                <div className="relative">
                  <div className="w-20 h-20 bg-white/80 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-4 border border-blue-200 shadow-sm group-hover:border-blue-300 transition-all duration-500">
                    <stat.icon className="w-8 h-8 text-blue-600 group-hover:text-blue-700 transition-colors duration-300" />
                  </div>
                  <div className="absolute inset-0 bg-blue-500/0 group-hover:bg-blue-500/5 rounded-2xl transition-all duration-500"></div>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card hover className="text-center group bg-white/80 backdrop-blur-xl border border-blue-200 relative overflow-hidden shadow-lg">
              ...
              <div className="relative z-10">
                <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center mx-auto mb-6 border border-blue-300 shadow-md group-hover:border-blue-400 transition-all duration-500">
                  <Camera className="w-10 h-10 text-blue-600 group-hover:text-blue-700 transition-colors duration-300" />
                </div>
                <h3 className="text-2xl font-bold text-slate-800 mb-4">Face Scan</h3>
            ...
            <Card hover className="text-center group bg-white/80 backdrop-blur-xl border border-blue-200 relative overflow-hidden shadow-lg">
              ...
              <div className="relative z-10">
                <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center mx-auto mb-6 border border-blue-300 shadow-md group-hover:border-blue-400 transition-all duration-500">
                  <UserPlus className="w-10 h-10 text-blue-600 group-hover:text-blue-700 transition-colors duration-300" />
                </div>
                <h3 className="text-2xl font-bold text-slate-800 mb-4">Face Enrollment</h3>
                <p className="text-slate-600 mb-6 leading-relaxed font-light">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="text-center group bg-white/80 backdrop-blur-xl border border-blue-200 hover:border-blue-300 transition-all duration-500 relative overflow-hidden shadow-lg">
                <div className="absolute inset-0 bg-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative z-10">
                  <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mx-auto mb-6 border border-blue-300 shadow-md group-hover:border-blue-400 transition-all duration-500">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          <Card className="bg-white/90 backdrop-blur-2xl border border-blue-300 p-12 relative overflow-hidden group shadow-2xl">
            {/* Grid Background */}
            ...
            <div className="relative z-10">
              <div className="flex justify-center mb-6">
                <div className="inline-flex items-center px-4 py-2 bg-blue-500/10 border border-blue-400/30 rounded-full">
                  <span className="text-blue-700 text-sm font-semibold">SYSTEM READY</span>
                </div>
              </div>
              ...
              <p className="text-xl text-slate-700 mb-8 max-w-2xl mx-auto font-light">
                Join the digital frontier with our secure biometric authentication system
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link href="/verification">
                  <Button size="lg" className="bg-blue-600 hover:bg-blue-700 border-0 text-white font-semibold transform hover:scale-105 transition-all duration-300 shadow-lg shadow-blue-500/25 relative overflow-hidden group">
                ...
                <Link href="/register">
                  <Button variant="outline" size="lg" className="bg-transparent border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white transform hover:scale-105 transition-all duration-300 relative overflow-hidden group">
      ...
      {/* Footer */}
      <footer className="bg-white/80 backdrop-blur-xl border-t border-blue-200 py-12 px-4 sm:px-6 lg:px-8 relative shadow-sm">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-4 mb-6 md:mb-0">
              ...
              <div>
                <h3 className="font-semibold text-slate-800">University of Port Harcourt</h3>
                <p className="text-slate-600 text-sm">FaceID Verification System</p>
              </div>
            </div>
