    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-slate-100 py-4 sm:py-6 lg:py-8 px-3 sm:px-4 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-4 sm:mb-6 lg:mb-8">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-slate-800 mb-2 sm:mb-4">
            Student Dashboard
          </h1>
        ...
        {/* Welcome Card */}
        <Card className="bg-white/90 backdrop-blur-2xl border border-blue-300 shadow-xl mb-4 sm:mb-6 lg:mb-8">
          <div className="flex flex-col sm:flex-row items-center justify-between p-4 sm:p-6">
            ...
            <div className="text-center sm:text-right mt-3 sm:mt-0">
              ...
              <p className="text-base sm:text-lg font-semibold text-blue-700">{student.matricNumber}</p>
              <p className="text-xs text-slate-500 mt-1">Face ID: {student.faceId}</p>
            </div>
          </div>
        </Card>
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium text-slate-800 text-xs sm:text-sm text-right">{student.department}</span>
                  </div>
                  <div className="flex justify-between items-center">
        ...
        {/* Security Status */}
        <Card className="mt-4 sm:mt-6 lg:mt-8 bg-white/90 backdrop-blur-2xl border border-green-300 shadow-xl">
          <div className="p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
              ...
              <div className="flex items-center space-x-2 text-green-600">
                ...
                <span className="font-medium text-sm sm:text-base">All Systems Active</span>
              </div>
            </div>
          </div>
        </Card>
